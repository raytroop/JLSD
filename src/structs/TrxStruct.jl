...
@kwdef mutable struct Clkgen
    ...
    # into a pending RX cursor candidate and committed only after sampling.
    ...
    # Pending candidate generated by clkgen_pi_itp_top!.  It is committed only
    # after rxw_covers succeeds and the sub-block is actually sampled.
...
scheduler.  Cost for the default 1024×24 block is ~768 KiB of Float64 —
negligible.
